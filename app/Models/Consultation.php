...
class Consultation extends Model
{
    ...
    protected $fillable = [
        ...
        'duration','amount','admin_amount','lawyer_amount','commission_percentage','lawyer_id','status','zoom_meeting_id','zoom_join_url','meeting_start_time','meeting_end_time','is_completed','is_extended','platform'
    ];
