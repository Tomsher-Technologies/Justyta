...
class LawyerController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'bar_card_expiry' => 'required|date',
            'practicing_lawyer_card_expiry' => 'required|date',
            'emirates_id_front' => 'nullable|file|mimes:jpg,jpeg,webp,png,svg,pdf|max:500',
            'emirates_id_back' => 'nullable|file|mimes:jpg,jpeg,webp,png,svg,pdf|max:500',
        ...
        $lawyer->update([
            ...
            'emirate_id_front'                  => $this->replaceFile($request, 'emirates_id_front', $lawyer, $uploadPath, 'emirate_id_front_'),
            'emirate_id_back'                   => $this->replaceFile($request, 'emirates_id_back', $lawyer, $uploadPath, 'emirate_id_back_'),
