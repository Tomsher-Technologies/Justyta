                    ...
                    <div class="card-body py-md-20">
                        <div class="horizontal-form">
                            <form action="{{ route('roles.store') }}" method="POST">
                                ...
                                <div class="form-group row mb-25">
                                    <div class="col-sm-12 d-flex aling-items-center">
                                        <label class="col-form-label  color-dark fw-500 align-center">Permissions <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-sm-12">
                                                ...
                                                <div class="permission-group">
                                                    <label class="parent-label checkbox-label">
                                                        <input type="checkbox" name="permissions[]" value="{{ $parent->name }}"
                                                            class="parent-checkbox  demo-sw mr-2" data-parent="{{ $parent->name }}">
                                                        {{ $parent->title }}
                                                    </label>
                                                        ...
                                                        @foreach ($parent->children as $child)
                                                            <label class="child-label checkbox-label">
                                                                <input type="checkbox" name="permissions[]"
                                                                    value="{{ $child->name }}" class="child-checkbox  demo-sw mr-2"
