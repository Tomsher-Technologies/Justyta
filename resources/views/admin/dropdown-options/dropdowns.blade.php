...
<div class="container mt-5">
    <h1 class="mb-4">Dropdown Groups</h1>

    @if($dropdowns->isEmpty())
        <div class="alert alert-info">No dropdown groups found.</div>
    @else
                ...
                <div class="col mt-3">
                    <a href="{{ route('dropdown-options.index', $dropdown->id) }}" class="text-decoration-none">
                        <div class="card h-100 shadow-sm border-primary hover-shadow">
                            <div class="card-body d-flex flex-column justify-content-center align-items-center text-center dropdown-card">
