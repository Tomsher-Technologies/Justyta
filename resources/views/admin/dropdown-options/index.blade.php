                            ...
                            <div class="horizontal-form">
                                <form method="POST" action="{{ route('dropdown-options.store', $dropdown->id) }}">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-3">
                                            <label class="col-form-label color-dark fw-500 align-center">Name ({{ $lang->name }})</label>
                                            <input type="text" name="translations[{{ $lang->code }}][name]" class="form-control ih-small ip-gray radius-xs b-light px-15 @error('translations.'.$lang->code.'.name') is-invalid @enderror" value="{{ old('translations.'.$lang->code.'.name') }}">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select name="status" class="form-control ih-small ip-gray radius-xs b-light px-15 @error('status') is-invalid @enderror">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="number" name="sort_order" class="form-control ih-small ip-gray radius-xs b-light px-15 @error('sort_order') is-invalid @enderror" value="{{ old('sort_order', 1) }}">
                                        ...
                                        <div class="col-md-2 align-self-end d-flex">
                                            ...
                                            <a href="{{ route('dropdowns.index') }}" class="btn btn-secondary btn-sm ml-1">Cancel</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card-body p-0">
                            <table class="table table-bordered table-basic mb-0">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                                ...
                                                @can('edit_dropdown_option')
                                                    ...
                                                    <div class="atbd-switch-wrap">
                                                        <div class="custom-control custom-switch switch-secondary switch-sm ">
                                                            <input type="checkbox" class="custom-control-input" id="switch-s1_{{$key}}" onchange="update_status(this)" value="{{ $option->id }}" <?php if ($option->status === 'active') {
                                                                echo 'checked';
                                                            } ?>>
                                            ...
                                            <td class="text-center">
                                                <div class="table-actions">
                                                    <a href="javascript:void(0)" role="button" title="Edit Options" data-toggle="modal" data-target="#editOptionModal" 
                                                            data-id="{{ $option->id }}"
                                                            data-status="{{ $option->status }}"
                                                            data-sort_order="{{ $option->sort_order }}"
                                                            @foreach ($languages as $lang)
                                                                data-name-{{ $lang->code }}="{{ $option->translations->firstWhere('language_code', $lang->code)?->name }}"
                                                            @endforeach>
                                    ...
                                    @empty
                                        <tr><td colspan="{{ 3 + $languages->count() }}" class="text-center">No options available.</td></tr>
                                    @endforelse
                                </tbody>
                            </table>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body row g-3">
                @foreach ($languages as $lang)
                    <div class="col-md-6">
                        <label class="col-form-label color-dark fw-500 align-center">Name ({{ $lang->name }})</label>
                        <input type="text" name="translations[{{ $lang->code }}][name]" class="form-control ih-small ip-gray radius-xs b-light px-15"
                ...
                <div class="col-md-6">
                    <label  class="col-form-label color-dark fw-500 align-center">Status</label>
                    <select name="status" class="form-control ih-small ip-gray radius-xs b-light px-15" id="edit-status">
                ...
                <div class="col-md-6">
                    <label class="col-form-label color-dark fw-500 align-center">Sort Order</label>
                    <input type="number" name="sort_order" class="form-control ih-small ip-gray radius-xs b-light px-15" id="edit-sort-order">
                </div>
