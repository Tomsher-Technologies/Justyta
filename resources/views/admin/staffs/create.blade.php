                ...
                <form class="form-horizontal" autocomplete="off" action="{{ route('staffs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="Enter name.." id="name" name="name" class="form-control ih-small ip-gray radius-xs b-light px-15" value="{{ old('name') }}">
                                @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="Enter email.." id="email" name="email" class="form-control ih-small ip-gray radius-xs b-light px-15"  value="{{ old('email') }}">
                                @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" placeholder="Enter phone number.." id="mobile" name="mobile" class="form-control ih-small ip-gray radius-xs b-light px-15"  value="{{ old('mobile') }}">
                                @error('mobile')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="role"  class="form-control ih-small ip-gray radius-xs b-light px-15 aiz-selectpicker">
