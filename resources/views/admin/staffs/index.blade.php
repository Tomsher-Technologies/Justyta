                    ...
                    <div class="table4  bg-white mb-30">
                        ...
                        <form class="row mb-2" id="sort_brands" action="" method="GET">
                            <div class="col-md-3 input-group  mb-1">
                                <input type="text" class="form-control ih-small ip-gray radius-xs b-light px-15" id="search"
                                    name="search"@isset($sort_search) value="{{ $sort_search }}" @endisset
                                    placeholder="Type name,email or phone">
                            </div>

                            <div class="col-md-3 input-group  mb-1">
                                <select name="role_id"  class="form-control ih-small ip-gray radius-xs b-light px-15 aiz-selectpicker">
                                                        ...
                                                        @can('edit_staff')
                                                            ...
                                                            <div class="atbd-switch-wrap">
                                                                <div class="custom-control custom-switch switch-secondary switch-sm ">
                                                                    <input type="checkbox" class="custom-control-input" id="switch-s1_{{$key}}" onchange="update_status(this)" value="{{ $staff->id }}" <?php if ($staff->banned == 0) {
                                                                        echo 'checked';
                                                                    } ?>>
                                                    ...
                                                    <td class="text-center">
                                                        @can('edit_staff')
                                                            <div class="table-actions">
                                                                <a href="{{route('staffs.edit', encrypt($staff->id))}}" title="Edit Staff">
