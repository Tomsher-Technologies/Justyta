        ...
        <div class="col-lg-10 mx-auto">
            <div class="card card-horizontal card-default card-md mb-4">
                <div class="card-header">
                    <h5 class="mb-0 h4">Edit Section for: {{ $page->name }}</h5>
                </div>
                <div class="card-body pb-md-30">
                    <form class="form-horizontal row" autocomplete="off" action="{{ route('pages.sections.update', [$page, $section]) }}" method="POST"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            @if($section->image)
                            <img id="currentImage" src="{{ asset(getUploadedImage($section->image)) }}" alt="Current Image" class="mt-3 img-thumbnail"
                                style="max-height: 150px;" />
                            @endif
                            <img id="imagePreview" src="#" alt="New Image Preview" class="mt-3 img-thumbnail d-none"
                                style="max-height: 150px;" />
                            @error('image')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                                ...
                                <div class="tab-pane fade @if ($loop->first) show active @endif"
                                    ...
                                    <div class="form-group mt-4">
                                        ...
                                        <div class="repeater-container" data-lang="{{ $lang->code }}">
                                            ...
                                            if(is_null($contentItems)) $contentItems = [];
                                            @endphp
                                                ...
                                                <div class="card-body p-3 relative">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-2">
                                                            <label>Title</label>
                                                            <input type="text" name="translations[{{ $lang->code }}][content][{{ $index }}][title]" class="form-control" value="{{ $item['title'] ?? '' }}">
                                                        </div>
                                                        <div class="col-md-6 mb-2">
                                                            <label>URL</label>
                                                            <input type="text" name="translations[{{ $lang->code }}][content][{{ $index }}][url]" class="form-control" value="{{ $item['url'] ?? '' }}">
                                                        </div>
                                                        <div class="col-md-12 mb-2">
                                                            <label>Description</label>
                                                            <textarea name="translations[{{ $lang->code }}][content][{{ $index }}][description]" class="form-control" rows="2">{{ $item['description'] ?? '' }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
