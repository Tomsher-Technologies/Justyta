                                            ...
                                            @if ($translatorPricing->isNotEmpty())
                                                @foreach ($translatorPricing as $key => $trans)
                                                    <tr>
                                                        ...
                                                        <td class="text-left"> 
                                                            Normal Priority
                                                            <i class="fas fa-info-circle text-primary ml-2 popover-toggle" tabindex="0" data-toggle="popover" data-placement="bottom" data-html="true" data-trigger="manual" title='<div class="popover-title">Hour Details</div>' data-content=' <div class="custom-popover">
