                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" step="0.01" name="normal" id="normal" value="{{ old('normal', $pricing->normal) }}" class="form-control" />
                                            @error('normal')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" step="0.01" name="urgent" id="urgent" value="{{ old('urgent', $pricing->urgent) }}" class="form-control" />
                                            @error('urgent')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" step="0.01" name="email_delivery" id="email_delivery" value="{{ old('email_delivery', $pricing->email) }}" class="form-control" />
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" step="0.01" name="physical_delivery" id="physical_delivery" value="{{ old('physical_delivery', $pricing->physical) }}" class="form-control" />
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <label class="col-form-label color-dark fw-500 align-center"> Admin Amount <span
                                                    class="text-danger">*</span> </label>
                                            <input type="number" step="0.01" name="admin_amount" id="admin_amount" value="{{ old('admin_amount', $pricing->admin_amount) }}" class="form-control" />
                                            @error('admin_amount')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" step="0.01" name="translator_amount" id="translator_amount" value="{{ old('translator_amount', $pricing->translator_amount) }}" class="form-control" />
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" readonly step="0.01" name="tax_amount" id="tax_amount" value="{{ old('tax_amount', $pricing->tax) }}" class="form-control" />
                                            @error('tax_amount')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 row">
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <input type="number" step="0.01" name="hours_1_10" id="hours_1_10" value="{{ old('hours_1_10', $pricing->hours_1_10) }}" class="form-control" />
                                                @error('hours_1_10')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <input type="number" step="0.01" name="hours_11_20" id="hours_11_20" value="{{ old('hours_11_20', $pricing->hours_11_20) }}" class="form-control" />
                                                @error('hours_11_20')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <input type="number" step="0.01" name="hours_21_30" id="hours_21_30" value="{{ old('hours_21_30', $pricing->hours_21_30) }}" class="form-control" />
                                                @error('hours_21_30')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <input type="number" step="0.01" name="hours_31_50" id="hours_31_50" value="{{ old('hours_31_50', $pricing->hours_31_50) }}" class="form-control" />
                                                @error('hours_31_50')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="col-md-2 mb-3">
                                                ...
                                                <input type="number" step="0.01" name="hours_above_50" id="hours_above_50" value="{{ old('hours_above_50', $pricing->hours_above_50) }}" class="form-control" />
