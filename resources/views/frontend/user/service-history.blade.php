...
@section('ads')
    ...
    @if($page == 'pending')
        @include('components.ad', ['page' => 'pending_services', 'device' => 'web'])
    @elseif ($page == 'history')
        @include('components.ad', ['page' => 'service_history', 'device' => 'web'])
    @elseif ($page == 'payment')
        @include('components.ad', ['page' => 'payment_history', 'device' => 'web'])
    @endif
