    ...
    <div class="grid grid-cols-1 gap-6">
        <div class=" bg-white p-10 rounded-[20px] border !border-[#FFE9B1] h-[calc(100vh-150px)]">
            ...
            <div class="text-center">
                <button onclick="window.close()" class="mt-8 inline-flex items-center gap-3 px-6 py-3 bg-transparatnt border border-[#4D1717] text-[#4D1717]  rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-gray-400">
