    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 bg-white p-6 xl:p-10 rounded-[20px] border !border-[#FFE9B1]">
            ...
            <p class="text-sm text-[#777777] mt-4 flex items-center gap-1">
                <svg class="w-12 h-12 text-[#777777]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="bg-white p-6 xl:p-10 rounded-[20px] border !border-[#FFE9B1] h-[auto] xl:h-[calc(100vh-150px)] flex flex-col justify-between">
                ...
                <div>
                    <div class="text-gray-700 text-lg mb-4 mt-5 xl:mt-0 text-center">{{ __('frontend.completion_hours') }} <span class="font-semibold text-xl text-[#07683B]" id="translation_completion_hours">0</span></div>
                    <div class="text-gray-700 text-lg mb-4 mt-5 xl:mt-0 text-center">{{ __('frontend.payment_amount') }} <span class="font-semibold text-xl text-[#07683B]" id="translation_price_result">{{ __('frontend.AED') }} 0.00</span></div>

                    <button type="submit" id="submit_button" class="text-white bg-[#04502E] hover:bg-[#02331D] focus:ring-4 focus:ring-blue-300 font-normal rounded-xl text-md w-full px-8 py-4 text-center transition-colors duration-200 uppercase cursor-pointer mt-5">
                        {{ __('frontend.submit') }}
                    </button>
                </div>
            </div>
...
@section('ads')
    ...
    @include('components.ad', ['page' => 'legal_translation', 'device' => 'web'])
@endsection
