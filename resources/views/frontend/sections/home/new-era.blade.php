    <section class="bg-[#B9A572] px-5 md:px-10 lg:px-10 py-[80px] gap-4">
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-6">
            <div class="text-white">
                ...
                @if (!empty($section->getTranslation('description', $lang)))
                    <div class="text-[16px] font-medium space-y-4">
                ...
                <div class="grid grid-cols-2 xl:grid-cols-3 gap-2">
                    ...
                    @foreach ($services as $service)
                        <div class="bg-white p-8">
                            ...
                            <h3 class="mb-6">{{ $service->getTranslation('title', $lang) }}</h3>
