    <section class="bg-[#FFF7F0] px-5 md:px-5 lg:px-5 py-[80px]">
        <h4 class="mb-3 text-[30px] text-[#034833] font-cinzel">{{ __('Latest News') }}</h4>
        ...
        <div class="text-center mt-5">
            <a href="{{ route('news') }}" class="inline-block px-6 py-2 text-white bg-[#034833] rounded hover:bg-[#023324] transition">{{ __('View All News') }}</a>
        </div>
    </section>