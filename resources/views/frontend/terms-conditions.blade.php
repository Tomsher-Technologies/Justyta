@extends('layouts.web_login', ['title' => 'Justyta Terms and Conditions'])
...
@section('content')    
    ...
    <section class="py-[40px] md:py-[0px] px-20 md:px-10 lg:px-20 xl:px-0">
      <div class="container m-auto px-20">
         ...
         @endphp
         <h1 class="mb-5 text-5xl text-[#034833] font-cinzel text-center">{{ $pageData?->getTranslation('title', $lang) }}</h1>
         <!-- Meta -->
