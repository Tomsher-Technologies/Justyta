                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" class="devicewidth">
                    <tr>
                        <td>
                            <table width="100%" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0"
                                align="center" class="full"
                                style=" border-bottom: 1px solid #e5e5e5;padding:5%;">
                                <tr>
                                    <td class="heightsmalldevices" height="40">&nbsp;</td>
                                </tr>
                                <tr style="text-align: center;">
                                    <td
                                        style="font-weight: 700;font-size: 20px;color: #08683d;">
                                ...
                                <tr>
                                    <td style="font-size: 16px ;">
                                        <p>If this was you, please use the verification code below to proceed with resetting your password. If you did not make this request, please ignore this email — your account remains secure.</p>
                                        <p><strong>Note:</strong> This code is valid for 10 minutes only.</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td height="32">&nbsp;</td>
                                ...
                                <tr>
                                    <td align="center">
                                        <table width="150" align="center" border="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="center" bgcolor="#08683d" style="border-radius: 28px; font-size: 25px;font-weight: bold;color:white;"
                                                    height="51">
                                                    {{ $user->otp }}
                                                </td>
                                            </tr>
